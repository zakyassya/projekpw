    ...
    if(empty($errors)){
        ...
        if(empty($errors)){
            ...
            if(mysqli_stmt_execute($stmt)){
                $pesan = "Pengajuan Surat Domisili berhasil dikirim.";
            } else {
...
<head>
    ...
    <title>Pengajuan Surat Domisili - Kecamatan Digital</title>
...
<body>
    <div class="form-container">
        <div class="form-header">
            <h2><i class="bi bi-geo-alt me-3"></i>Pengajuan Surat Domisili</h2>
            <p>Lengkapi data untuk permohonan surat domisili</p>
        </div>
            ...
            <form method="POST" enctype="multipart/form-data" novalidate>
                ...
                <div class="d-flex gap-3">
                    <button type="submit" class="btn-submit">
                        <i class="bi bi-check-circle me-2"></i>Ajukan Surat Domisili
                    </button>
